<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewMember.aspx.cs" Inherits="Assignment.AdminViewMember" %>
...
<form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="Member List" Font-Size="36px" Font-Bold="true" ForeColor="#ff8c00"></asp:Label>
            </div>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="MemberID" DataSourceID="SqlDataSource1" AllowSorting="True" Style="width:100%;">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" DeleteCommand="DELETE FROM [member] WHERE [MemberID] = @MemberID" InsertCommand="INSERT INTO [member] ([MemberName], [Email], [Password], [SecurityQuestion], [SecurityAnswer]) VALUES (@MemberName, @Email, @Password, @SecurityQuestion, @SecurityAnswer)" SelectCommand="SELECT * FROM [member]" UpdateCommand="UPDATE [member] SET [MemberName] = @MemberName, [Email] = @Email, [Password] = @Password, [SecurityQuestion] = @SecurityQuestion, [SecurityAnswer] = @SecurityAnswer WHERE [MemberID] = @MemberID">
                <DeleteParameters>
            ...
            <br />
            <asp:Label ID="label" runat="server" Text="Hash Function" Font-Size="36px" Font-Bold="True" ForeColor="Pink"></asp:Label>
            <br />
            <br />
            ...
            <br />
            <asp:TextBox ID="txtOutput" runat="server" OnTextChanged="txtOutput_TextChanged"></asp:TextBox>
            <br />
            <br />
