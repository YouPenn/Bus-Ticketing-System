<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewPayment.aspx.cs" Inherits="Assignment.AdminViewPayment" %>
...
<form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="Payment List" Font-Size="36px" Font-Bold="true" ForeColor="#ff8c00"></asp:Label>
            </div>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="PaymentID" DataSourceID="SqlDataSource1" AllowSorting="True">
                <Columns>
                    ...
                    <asp:BoundField DataField="PaymentPrice" HeaderText="PaymentPrice" SortExpression="PaymentPrice" />
                    <asp:BoundField DataField="PaymentMethod" HeaderText="PaymentMethod" SortExpression="PaymentMethod" />
                    <asp:BoundField DataField="PaymentDateTime" HeaderText="PaymentDateTime" SortExpression="PaymentDateTime" DataFormatString="{0:yyyy-MM-dd}"/>
                </Columns>
                <HeaderStyle BackColor="#3498db" ForeColor="White" />
            </asp:GridView>

            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [payment] WHERE [PaymentID] = @PaymentID" InsertCommand="INSERT INTO [payment] ([CustomerID], [TicketID], [PaymentPrice], [PaymentMethod], [PaymentDateTime]) VALUES (@CustomerID, @TicketID, @PaymentPrice, @PaymentMethod, @PaymentDateTime)" SelectCommand="SELECT * FROM [payment]" UpdateCommand="UPDATE [payment] SET [CustomerID] = @CustomerID, [TicketID] = @TicketID, [PaymentPrice] = @PaymentPrice, [PaymentMethod] = @PaymentMethod, [PaymentDateTime] = @PaymentDateTime WHERE [PaymentID] = @PaymentID">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="PaymentPrice" Type="Decimal" />
                    <asp:Parameter Name="PaymentMethod" Type="String" />
                    <asp:Parameter Name="PaymentDateTime" Type="DateTime" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="CustomerID" Type="Int32" />
                    <asp:Parameter Name="TicketID" Type="Int32" />
