<%@ Page Language="C#" MasterPageFile="~/Nav.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="Assignment.Client.ForgotPassword" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <form id="form1">
        <div id="login-container" style="text-align: center; margin: 5px auto; width: 60%;">
            <div>
                <h1 style="color: #007BFF; font-size: 2em; font-weight: bold; text-align: center; background-color: #f2f2f2; padding: 20px; border-radius: 10px;">Forgot Password</h1>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="auto-style5">
                                ...
                                <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtEmail"
                                    Display="Dynamic" ErrorMessage="*" ForeColor="Red" ValidationGroup="ForgotPassword"></asp:RequiredFieldValidator><br />
                                <asp:RegularExpressionValidator ID="revEmailFormat" runat="server" ControlToValidate="txtEmail"
                                    ...
                                    ForeColor="Red" ValidationGroup="ForgotPassword"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style3">
                            ...
                            <td class="auto-style4">:</td>
                            <td class="auto-style5">
                                <asp:TextBox ID="txtSecurityQuestions" runat="server" Enabled="False"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style3">
                            ...
                            <td class="auto-style5">
                                ...
                                <asp:RequiredFieldValidator ID="rfvSecurityAnswer" runat="server" ControlToValidate="txtSecurityAnswer"
                                    Display="Dynamic" ErrorMessage="*" ForeColor="Red" ValidationGroup="ForgotPassword"></asp:RequiredFieldValidator><br />
                                <asp:RegularExpressionValidator ID="revSecurityAnswer" runat="server" ControlToValidate="txtSecurityAnswer"
                                    Display="Dynamic" ErrorMessage="Security answer do not match"
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Submit" CssClass="action-button" ValidationGroup="ForgotPassword" />
                            </td>
                        </tr>
