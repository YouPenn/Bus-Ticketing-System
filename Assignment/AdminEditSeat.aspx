<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEditSeat.aspx.cs" Inherits="Assignment.AdminEditSeat" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="Edit Seat " Font-Size="36px" Font-Bold="true" ForeColor="#ff8c00"></asp:Label>
            </div>
            <br />
            <br />
            ...
            <br />
            <asp:DropDownList ID="ddlFilter" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="ScheduleID" DataValueField="ScheduleID">
                <asp:ListItem>available</asp:ListItem>
                <asp:ListItem>unavailable</asp:ListItem>
                <asp:ListItem>maintaining</asp:ListItem>
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ScheduleID] FROM [schedule]"></asp:SqlDataSource>
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="SeatID" DataSourceID="SqlDataSource2" Width="357px" AllowSorting="True" OnRowEditing="GridView1_RowEditing">
                <Columns>
                    <asp:CommandField ShowEditButton="True" ControlStyle-CssClass="editButton"/>
                    <asp:BoundField DataField="SeatID" HeaderText="SeatID" ReadOnly="True" SortExpression="SeatID" InsertVisible="False" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [seat] WHERE [SeatID] = @SeatID" InsertCommand="INSERT INTO [seat] ([BusID], [ScheduleID], [AvailableSeat], [SeatNumber]) VALUES (@BusID, @ScheduleID, @AvailableSeat, @SeatNumber)" SelectCommand="SELECT * FROM [seat] WHERE ([ScheduleID] = @ScheduleID)" UpdateCommand="UPDATE [seat] SET [BusID] = @BusID, [ScheduleID] = @ScheduleID, [AvailableSeat] = @AvailableSeat, [SeatNumber] = @SeatNumber WHERE [SeatID] = @SeatID">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="AvailableSeat" Type="String" />
                    <asp:Parameter Name="SeatNumber" Type="Int32" />
                </InsertParameters>
                <SelectParameters>
                    <asp:ControlParameter ControlID="ddlFilter" Name="ScheduleID" PropertyName="SelectedValue" Type="String" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="BusID" Type="String" />
                    <asp:Parameter Name="ScheduleID" Type="String" />
