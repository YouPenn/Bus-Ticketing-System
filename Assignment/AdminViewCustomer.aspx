<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewCustomer.aspx.cs" Inherits="Assignment.AdminViewCustomer" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="Customer List" Font-Size="36px" Font-Bold="true" ForeColor="#ff8c00"></asp:Label>
            </div>
            <br />
            <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [customer] WHERE [CustomerID] = @CustomerID" InsertCommand="INSERT INTO [customer] ([CustomerName ], [CustomerPhoneNumber]) VALUES (@CustomerName_, @CustomerPhoneNumber)" SelectCommand="SELECT * FROM [customer]" UpdateCommand="UPDATE [customer] SET [CustomerName ] = @CustomerName_, [CustomerPhoneNumber] = @CustomerPhoneNumber WHERE [CustomerID] = @CustomerID">
                <DeleteParameters>
                    <asp:Parameter Name="CustomerID" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="CustomerName_" Type="String" />
